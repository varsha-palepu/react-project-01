      ...
      <Dialog as="div" className="relative z-10" initialFocus={cancelButtonRef} onClose={setOpen}>
        ...
        <div className="fixed inset-0 w-screen z-10  overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-gray-50 text-center shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            ...
            <div>
              {/* <label htmlFor="lname" className="block text-sm font-medium leading-6 text-gray-900 text-left">
                Last Name
              </label> */}
              <div className="mt-2">
                <input
              ...
              <div className="mt-2">
                ...
                <div className="bg-gray-100 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 text-center">
  <button
    type="button"
    className="inline-flex items-center justify-center rounded-md bg-gray-600 hover:bg-gray-700 px-3 py-2 text-sm font-semibold text-white shadow-sm sm:mx-auto sm:my-0 sm:w-auto"
    onClick={handleClick}
  >
    Sign Up
  </button>
